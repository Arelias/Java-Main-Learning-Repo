...
public class BookDirectoryTestSuite {
    ...
    //Test if good list returns proper values
    @Test
    public void testListBooksWithConditionsReturnList() {
        ...
        System.out.println(bookLibrary.listBooksWithCondition("Secret"));
        // Then
    ...
    public void testListBooksWithConditionMoreThan20() {
        ...
        //General condition always before specific condition
        //Because conditions are stored on stack
        //So what is added first, will be checked last
    ...
    @Test
    public void testListBooksInHandsOfEmptyList(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOfBooks = new ArrayList<Book>();
    ...
    @Test
    public void testListBooksInHandsOfSingleBookList(){
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
    ...
    @Test
    public void testListBooksInHandsOfFiveBooksList(){
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
